...
export const Quiz = ({
    ...
    const [
        ...
        _c,
        correctControls,
    ] = useAudio({ src: "/correct.waw" })
    const [
        incorrectAudio,
        _i,
        incorrectControls,
    ] = useAudio({ src: "/incorrect.waw" })
        ...
        return (
            <>
                ...
                <Confetti
                    ...
                    numberOfPieces={500}
                    tweenDuration={10000} />
                <div className="flex flex-col gap-y-4 lg:gap-y-8 max-w max-auto text-center items-center justify-center h-full">
